...
(function ($) {
    $(function () {
        $('div.share42init').each(function (idx) {
            ...
            var s = new Array(
                '"#" data-count="vk" title="Share on VK"',
                '"#" data-count="fb" title="Share on Facebook"',
                '"#" data-count="gplus" title="Share on Google+"',
                '"#" data-count="twi" title="Share on Twitter"',
                '"#" data-count="odkl" title="Share to Odnoklassniki.ru"');
            var l = '';
            for (j = 0; j < s.length; j++)l += '<span class="share42-item" style="display:inline-block;height:48px;"><a rel="nofollow" style="display:inline-block;width:48px;height:48px;margin:0;padding:0;outline:none;background:url(' + f + fn + ') -' + 48 * j + 'px 0 no-repeat" href=' + s[j] + ' target="_blank"></a></span>';
            el.html('<span id="share42">' + l + '</span>' + '');

            el.find('[data-count="vk"]').click(function(e) {
                e.preventDefault();
            ...
            el.find('[data-count="fb"]').click(function(e) {
                e.preventDefault();
            ...
            el.find('[data-count="gplus"]').click(function(e) {
                e.preventDefault();
            ...
            el.find('[data-count="twi"]').click(function(e) {
                e.preventDefault();
            ...
            el.find('[data-count="odkl"]').click(function(e) {
                e.preventDefault();

                window.open('http://www.odnoklassniki.ru/dk?st.cmd=addShare&st._surl=' + u + '&title=' + t, '_blank', 'scrollbars=0, resizable=1, menubar=0, left=100, top=100, width=550, height=440, toolbar=0, status=0');
            });
        })
    })
})(jQuery);